...
var definitions = map[string]Definition{
	...
	"reverse_proxy_clusters.delete":     {Name: "reverse_proxy_clusters.delete", Method: "DELETE", Path: "/api/reverse-proxies/clusters/{clusterAddress}", Mutation: Consequential, RequiresPreimage: true, RequiresReadBack: true, DispatcherAdmitted: true},
	"reverse_proxy_services.create":     {Name: "reverse_proxy_services.create", Method: "POST", Path: "/api/reverse-proxies/services", Mutation: Consequential, RequiresPreimage: true, RequiresReadBack: true, DispatcherAdmitted: true},
	"reverse_proxy_services.update":     {Name: "reverse_proxy_services.update", Method: "PUT", Path: "/api/reverse-proxies/services/{serviceId}", Mutation: Consequential, RequiresPreimage: true, RequiresReadBack: true, DispatcherAdmitted: true},
	"reverse_proxy_services.delete":     {Name: "reverse_proxy_services.delete", Method: "DELETE", Path: "/api/reverse-proxies/services/{serviceId}", Mutation: Consequential, RequiresPreimage: true, RequiresReadBack: true, DispatcherAdmitted: true},
	"notification_channels.create":      {Name: "notification_channels.create", Method: "POST", Path: "/api/integrations/notifications/channels", Mutation: Consequential, RequiresPreimage: true, RequiresReadBack: true, DispatcherAdmitted: true},
	"notification_channels.update":      {Name: "notification_channels.update", Method: "PUT", Path: "/api/integrations/notifications/channels/{channelId}", Mutation: Consequential, RequiresPreimage: true, RequiresReadBack: true, DispatcherAdmitted: true},
	"notification_channels.delete":      {Name: "notification_channels.delete", Method: "DELETE", Path: "/api/integrations/notifications/channels/{channelId}", Mutation: Consequential, RequiresPreimage: true, RequiresReadBack: true, DispatcherAdmitted: true},
	...
	"google_idp.create":                 {Name: "google_idp.create", Method: "POST", Path: "/api/integrations/google-idp", Mutation: Consequential, RequiresPreimage: true, RequiresReadBack: false, DispatcherAdmitted: true},
	"google_idp.update":                 {Name: "google_idp.update", Method: "PUT", Path: "/api/integrations/google-idp/{id}", Mutation: Consequential, RequiresPreimage: true, RequiresReadBack: true, DispatcherAdmitted: true},
	"google_idp.delete":                 {Name: "google_idp.delete", Method: "DELETE", Path: "/api/integrations/google-idp/{id}", Mutation: Consequential, RequiresPreimage: true, RequiresReadBack: true, DispatcherAdmitted: true},
	"google_idp.sync":                   {Name: "google_idp.sync", Method: "POST", Path: "/api/integrations/google-idp/{id}/sync", Mutation: Consequential, RequiresPreimage: true, RequiresReadBack: false, DispatcherAdmitted: true},
	"edr.intune.create":                 {Name: "edr.intune.create", Method: "POST", Path: "/api/integrations/edr/intune", Mutation: Consequential, RequiresPreimage: true, RequiresReadBack: true, DispatcherAdmitted: true},
	"edr.intune.update":                 {Name: "edr.intune.update", Method: "PUT", Path: "/api/integrations/edr/intune", Mutation: Consequential, RequiresPreimage: true, RequiresReadBack: true, DispatcherAdmitted: true},
	"edr.intune.delete":                 {Name: "edr.intune.delete", Method: "DELETE", Path: "/api/integrations/edr/intune", Mutation: Consequential, RequiresPreimage: true, RequiresReadBack: true, DispatcherAdmitted: true},
	"edr.sentinelone.create":            {Name: "edr.sentinelone.create", Method: "POST", Path: "/api/integrations/edr/sentinelone", Mutation: Consequential, RequiresPreimage: true, RequiresReadBack: true, DispatcherAdmitted: true},
	"edr.sentinelone.update":            {Name: "edr.sentinelone.update", Method: "PUT", Path: "/api/integrations/edr/sentinelone", Mutation: Consequential, RequiresPreimage: true, RequiresReadBack: true, DispatcherAdmitted: true},
	"edr.sentinelone.delete":            {Name: "edr.sentinelone.delete", Method: "DELETE", Path: "/api/integrations/edr/sentinelone", Mutation: Consequential, RequiresPreimage: true, RequiresReadBack: true, DispatcherAdmitted: true},
	"edr.falcon.create":                 {Name: "edr.falcon.create", Method: "POST", Path: "/api/integrations/edr/falcon", Mutation: Consequential, RequiresPreimage: true, RequiresReadBack: true, DispatcherAdmitted: true},
	"edr.falcon.update":                 {Name: "edr.falcon.update", Method: "PUT", Path: "/api/integrations/edr/falcon", Mutation: Consequential, RequiresPreimage: true, RequiresReadBack: true, DispatcherAdmitted: true},
	"edr.falcon.delete":                 {Name: "edr.falcon.delete", Method: "DELETE", Path: "/api/integrations/edr/falcon", Mutation: Consequential, RequiresPreimage: true, RequiresReadBack: true, DispatcherAdmitted: true},
	"edr.huntress.create":               {Name: "edr.huntress.create", Method: "POST", Path: "/api/integrations/edr/huntress", Mutation: Consequential, RequiresPreimage: true, RequiresReadBack: true, DispatcherAdmitted: true},
	"edr.huntress.update":               {Name: "edr.huntress.update", Method: "PUT", Path: "/api/integrations/edr/huntress", Mutation: Consequential, RequiresPreimage: true, RequiresReadBack: true, DispatcherAdmitted: true},
	"edr.huntress.delete":               {Name: "edr.huntress.delete", Method: "DELETE", Path: "/api/integrations/edr/huntress", Mutation: Consequential, RequiresPreimage: true, RequiresReadBack: true, DispatcherAdmitted: true},
	"edr.fleetdm.create":                {Name: "edr.fleetdm.create", Method: "POST", Path: "/api/integrations/edr/fleetdm", Mutation: Consequential, RequiresPreimage: true, RequiresReadBack: true, DispatcherAdmitted: true},
	"edr.fleetdm.update":                {Name: "edr.fleetdm.update", Method: "PUT", Path: "/api/integrations/edr/fleetdm", Mutation: Consequential, RequiresPreimage: true, RequiresReadBack: true, DispatcherAdmitted: true},
	"edr.fleetdm.delete":                {Name: "edr.fleetdm.delete", Method: "DELETE", Path: "/api/integrations/edr/fleetdm", Mutation: Consequential, RequiresPreimage: true, RequiresReadBack: true, DispatcherAdmitted: true},
	"scim.create":                       {Name: "scim.create", Method: "POST", Path: "/api/integrations/scim-idp", Mutation: Consequential, RequiresPreimage: true, RequiresReadBack: true, DispatcherAdmitted: true},
	"scim.update":                       {Name: "scim.update", Method: "PUT", Path: "/api/integrations/scim-idp/{id}", Mutation: Consequential, RequiresPreimage: true, RequiresReadBack: true, DispatcherAdmitted: true},
	"scim.delete":                       {Name: "scim.delete", Method: "DELETE", Path: "/api/integrations/scim-idp/{id}", Mutation: Consequential, RequiresPreimage: true, RequiresReadBack: true, DispatcherAdmitted: true},
	"scim.token":                        {Name: "scim.token", Method: "POST", Path: "/api/integrations/scim-idp/{id}/token", Mutation: Consequential, RequiresPreimage: true, RequiresReadBack: false, DispatcherAdmitted: true},
	"okta_scim.create":                  {Name: "okta_scim.create", Method: "POST", Path: "/api/integrations/okta-scim-idp", Mutation: Consequential, RequiresPreimage: true, RequiresReadBack: true, DispatcherAdmitted: true},
	"okta_scim.update":                  {Name: "okta_scim.update", Method: "PUT", Path: "/api/integrations/okta-scim-idp/{id}", Mutation: Consequential, RequiresPreimage: true, RequiresReadBack: true, DispatcherAdmitted: true},
	"okta_scim.delete":                  {Name: "okta_scim.delete", Method: "DELETE", Path: "/api/integrations/okta-scim-idp/{id}", Mutation: Consequential, RequiresPreimage: true, RequiresReadBack: true, DispatcherAdmitted: true},
	"okta_scim.token":                   {Name: "okta_scim.token", Method: "POST", Path: "/api/integrations/okta-scim-idp/{id}/token", Mutation: Consequential, RequiresPreimage: true, RequiresReadBack: false, DispatcherAdmitted: true},
	"msp.tenants.create":                {Name: "msp.tenants.create", Method: "POST", Path: "/api/integrations/msp/tenants", Mutation: Consequential, RequiresPreimage: true, RequiresReadBack: true, DispatcherAdmitted: true},
	"msp.tenants.update":                {Name: "msp.tenants.update", Method: "PUT", Path: "/api/integrations/msp/tenants/{id}", Mutation: Consequential, RequiresPreimage: true, RequiresReadBack: true, DispatcherAdmitted: true},
	"msp.tenants.dns":                   {Name: "msp.tenants.dns", Method: "POST", Path: "/api/integrations/msp/tenants/{id}/dns", Mutation: Consequential, RequiresPreimage: true, RequiresReadBack: true, DispatcherAdmitted: true},
	"msp.tenants.invite":                {Name: "msp.tenants.invite", Method: "POST", Path: "/api/integrations/msp/tenants/{id}/invite", Mutation: Consequential, RequiresPreimage: true, RequiresReadBack: true, DispatcherAdmitted: true},
