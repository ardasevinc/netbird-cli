...
func applyReviewedOverrides(ops []operation) {
	reviewed := map[string]operation{
		...
		"POST /api/ingress/peers":                                 {ID: "ingress.peers.create", Implementation: "implemented", Verification: "contract_verified"},
		"PUT /api/ingress/peers/{ingressPeerId}":                  {ID: "ingress.peers.update", Implementation: "implemented", Verification: "contract_verified"},
		"DELETE /api/ingress/peers/{ingressPeerId}":               {ID: "ingress.peers.delete", Implementation: "implemented", Verification: "contract_verified"},
		...
		"POST /api/peers/{peerId}/ingress/ports":                  {ID: "peers.ingress.ports.create", Implementation: "implemented", Verification: "contract_verified"},
		"PUT /api/peers/{peerId}/ingress/ports/{allocationId}":    {ID: "peers.ingress.ports.update", Implementation: "implemented", Verification: "contract_verified"},
		"DELETE /api/peers/{peerId}/ingress/ports/{allocationId}": {ID: "peers.ingress.ports.delete", Implementation: "implemented", Verification: "contract_verified"},
